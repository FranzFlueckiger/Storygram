...
test('filter custom X filter', () => {
  ...
  const layersFF = [
    ...
    },
    {
      ...
      index: 4,
      isHidden: false,
      remove: ['bf', 'gf', 'kf', 'ff', 'zf', 'lf', 'cf', 'af'],
      state: [],
      switch: [],
      xValue: 8,
    },
