...
export class PreProcessing {
   ...
   */
    public static fromRanges(data: any[], yField: string, fromField: string, toField: string): Data {
   ...
   */
    public static fromArray(inputData: object[], xField: string, yFields: string[], splitFunction?: (arg: string) => string[]): Data {
