...
## Actor color
Callback that returns a string or a number indicating a color category. Note: it is not possible to assign directly a color to an actor like e.g. '#4287f5', it will get a color of the selected 
