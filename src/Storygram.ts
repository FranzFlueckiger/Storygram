...
export default class Storygram {
  ...
  private baseConfig: BaseConfig = {
    ...
    url: (event, actor) => 'https://www.google.ch/search?q=' + String(this.config.eventDescription) + ' ' + actor.actorID,
    eventUrl: (event) => 'https://www.google.ch/search?q=' + String(this.config.eventDescription),
    marginTop: 50,
    marginBottom: 50,
    marginLeft: 50,
    marginRight: 50,
